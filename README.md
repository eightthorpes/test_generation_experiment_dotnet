...
but using .NET which as a language that I don't know at all, is more of a 
challenge to me. 
### Procedure
1. Since I don't even know the basics of .NET development, all I did manually 
...
1. Next I copied the test plan from the Python project and asked Claude to implement the 14 test cases in .NET
...
I will have to go back and validate all of these to make sure they're valid once I know the .NET language better.
